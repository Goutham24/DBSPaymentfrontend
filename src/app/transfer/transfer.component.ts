...
export class TransferComponent implements OnInit {
  ...
  selectedMsgCode:any;
  alertmsg:any;
  constructor(private router:Router, private storageService:LocalStorageService,private custsvc:CustomerService ,private msgsvc:MessageService,private datasvc:DataService) {
...
handleTransfer() {
  ...
  iscustomer(){
    return this.customer.customertype==='C';
  }
  onAmountChange(){
    if(this.amount=="")
    this.transferfee="";
